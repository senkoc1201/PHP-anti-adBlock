...
<body>
    <center>
        <h3><a href="http://testsite.zone94.com/scripts/adshield2/adminpanel/index.php" target="_blank"> Click here to
                go to the Control Panel to reset the click count (Login: admin & admin)</a></h3>
    </center>
    <center>
        <h3>Click on the right mouse button 3 times to hide the Ad Unit.</h3>
    </center>
    <div style="text-align: center;">
        <h2>Ad Unit 1 (AdSense)</h2>
        <div class="custom-ad-unit-1">
            <ins class="adsbygoogle" style="display:inline-block;width:300px;height:250px"
                data-ad-client="ca-pub-2514525490159799" data-ad-slot="3339058173">
            </ins>
        ...
        <div id="gpt-passback">
                <script>
                    ...
                    googletag.cmd.push(function () {
                        googletag.defineSlot('/21988630651/Under_Top_Navigation_Bar_(Right)',
